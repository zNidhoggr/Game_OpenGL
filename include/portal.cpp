...
void Portal::teleport(Player& player, Game& game) {
    // Aqui tu vai botar a lógica pra mudar o mapa e mover o jogador
    player.setPosition(destinationX,  this->getTerrainHeight(destinationX, destinationZ), destinationZ);
